...
def get_weather(city: str):
    ...
    """
    try:
        api_key="a2fc305ee7ba500c1f491839a2157df1"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key="c531a6d46b9846b4be637892dcf77295"
...
def news_summarizer(url):
    response= client.models.generate_content(
        model='gemini-2.5-flash',
        contents=f"summarize news from the url:- {url}, don't add sentences like from where the articles is ,in this article etc. Just give clear and crisp summary.",
    )
...
def find_local_events(city: str):
    ...
    try:
        api_key="b8b7c03830cc37fcd08615ee72fb09ab92c9571269d7f6b24879c04d6f6757a2"
